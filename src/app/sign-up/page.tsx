            ...
            <section className="space-y-6">
              ...
              <div className="space-y-4">
                <h1 className="text-4xl font-bold leading-[1.1] tracking-[-0.03em] sm:text-5xl">
                  ...
                  <span className="bg-gradient-to-r from-amber-400 to-orange-400 bg-clip-text text-transparent"> documents</span>.
                </h1>
                <p className="max-w-md text-base leading-relaxed text-stone-500">
                  Create an account in one click with Google or GitHub. No forms, no passwords — jump straight into your dashboard.
                </p>
              </div>
              <div className="space-y-3">
                <div className="flex items-center gap-3 rounded-xl border border-stone-800/60 bg-stone-900/30 px-4 py-3">
                  ...
                  <div>
                    <p className="text-xs font-medium text-stone-300">Upload &amp; chat</p>
                    <p className="text-[11px] text-stone-600">Ask questions, get cited answers</p>
                  </div>
                </div>
                <div className="flex items-center gap-3 rounded-xl border border-stone-800/60 bg-stone-900/30 px-4 py-3">
                  <div className="flex h-8 w-8 shrink-0 items-center justify-center rounded-lg bg-amber-500/10">
                  ...
                  <div>
                    <p className="text-xs font-medium text-stone-300">Privacy first</p>
                    <p className="text-[11px] text-stone-600">Your documents stay private &amp; secure</p>
                  </div>
                </div>
              </div>
            </section>
