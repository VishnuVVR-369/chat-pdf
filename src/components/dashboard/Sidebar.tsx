        ...
        <div className="flex h-[56px] items-center px-3">
          {collapsed ? (
            <button
              ...
              className="focus-ring mx-auto rounded-lg transition-opacity hover:opacity-70"
            ...
            <>
              ...
              <button
                ...
                className="focus-ring flex h-7 w-7 items-center justify-center rounded-lg text-stone-500 transition-colors hover:bg-white/[0.06] hover:text-stone-300"
