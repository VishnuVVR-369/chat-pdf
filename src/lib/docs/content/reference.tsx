            ...
            <EnvTable
              rows={[
                ...
                },
                {
                  ...
                  purpose:
                    "Convex site URL used by auth and server integration.",
                },
              ]}
            />
          ),
            ...
            <EnvTable
              rows={[
                ...
                },
                {
                  ...
                  purpose: "Browser-readable Clerk publishable key.",
                },
                {
                  name: "CLERK_SECRET_KEY",
                  purpose: "Server-side Clerk secret key.",
                },
                {
                  name: "CLERK_JWT_ISSUER_DOMAIN",
                  purpose:
                    "Clerk JWT issuer domain used by Convex auth.config.ts.",
                },
                {
                  name: "NEXT_PUBLIC_CLERK_SIGN_IN_URL",
                  purpose: "Path for Clerk sign-in redirects.",
                },
                {
                  name: "NEXT_PUBLIC_CLERK_SIGN_UP_URL",
                  purpose: "Path for Clerk sign-up redirects.",
                },
                {
                  name: "NEXT_PUBLIC_CLERK_SIGN_IN_FALLBACK_REDIRECT_URL",
                  purpose: "Fallback destination after sign-in.",
                },
                {
                  name: "NEXT_PUBLIC_CLERK_SIGN_UP_FALLBACK_REDIRECT_URL",
                  purpose: "Fallback destination after sign-up.",
                },
              ]}
            />
          ),
              ...
              rows={[
                {
                  ...
                  purpose: "Mistral API key used for OCR processing.",
                },
                {
                  name: "MISTRAL_OCR_MODEL",
                  purpose:
                    "OCR model, defaulting to mistral-ocr-4-0 for OCR 4.",
                },
              ]}
            />
          ),
            ...
            <EnvTable
              rows={[
                ...
                },
                {
                  ...
                  purpose: "Chat model used for summaries and answers.",
                },
                {
                  ...
                  answer: (
                    <BulletList
                      items={[
                        ...
                        "Check that Clerk publishable and secret keys are present in the environment where Next.js runs.",
                        "Verify CLERK_JWT_ISSUER_DOMAIN matches the issuer configured for Convex.",
                      ]}
                    />
                  ),
                },
                  ...
                  answer: (
                    <BulletList
                      items={[
                        ...
                        "Verify MISTRAL_API_KEY and MISTRAL_OCR_MODEL before debugging OCR failures.",
